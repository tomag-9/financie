	...
	return (
		<div className="space-y-6">
			<div className="flex flex-wrap items-center justify-between gap-3">
				<div>
					<h1 className="text-xl font-semibold text-zinc-900 dark:text-zinc-100">AI Runner</h1>
			...
			<section className="space-y-3">
				...
				{isLoading ? (
					...
					<div className="grid gap-4">
						{alarms.map((alarm) => (
							<div key={alarm.id} className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
