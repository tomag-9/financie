  ...
  return (
    <section className="space-y-6">
      ...
      <div className="space-y-3 sm:hidden">
        {loading ? (
          <p className="rounded-lg border border-zinc-200 bg-white p-4 text-center text-sm text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-400">
            Loading accounts...
          </p>
          ...
          sortedAccounts.map((account, index) => {
            ...
            return (
              <article key={account.id} className="rounded-lg border border-zinc-200 bg-white p-3 dark:border-zinc-800 dark:bg-zinc-900">
                  ...
                  {isEditing ? (
                    ...
                    <>
                      ...
                      <p className="text-xs text-zinc-600 dark:text-zinc-300">
                        {account.type} · {account.currency} · Order {account.sortOrder}
                      </p>
                    </>
                  )}
      ...
      <div className="hidden overflow-x-auto rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900 sm:block">
